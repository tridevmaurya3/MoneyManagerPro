...
public class AddExpenseActivity extends AppCompatActivity {
    ...
    private void setupAmountAutoSync() {
        etAmount.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(
                ...
                amountManuallyOverridden = text != null
    ...
    private void syncAmountFromItems(BigDecimal itemsTotal) {
        ...
        try {
            if (itemsTotal != null
                    && itemsTotal.compareTo(BigDecimal.ZERO) > 0) {
    ...
    private BigDecimal calculateItemTotal(View row) {
        ...
        return ExpenseItemPriceCalculator.calculate(
                quantity,
                unit,
                price
        );
    ...
    private void updateItemsSummary() {
        ...
        itemsTotal = itemsTotal.setScale(
                2,
    ...
    private List<ExpenseItem> collectExpenseItems() {
        ...
        for (int index = 0; index < itemRows.size(); index++) {
            ...
            BigDecimal total =
                    ExpenseItemPriceCalculator.calculate(
                            quantity,
                            unit,
                            price
                    );
