...
public class PinActivity extends AppCompatActivity {
    ...
    private void bindViews() {
        txtPinTitle =
                findViewById(R.id.txtPinTitle);

        txtPinSubtitle =
                findViewById(R.id.txtPinSubtitle);

        inputPin =
                findViewById(R.id.inputPin);

        inputConfirmPin =
                findViewById(R.id.inputConfirmPin);

        etPin =
                findViewById(R.id.etPin);

        etConfirmPin =
                findViewById(R.id.etConfirmPin);

        confirmPinContainer =
                findViewById(R.id.confirmPinContainer);

        btnPinAction =
                findViewById(R.id.btnPinAction);
    ...
    private boolean resolveSecurityMode() {
        ...
        /*
         * PIN setup was previously skipped or PIN Lock was disabled
         * from Settings. Continue directly to the dashboard.
         */
    ...
    private void configurePinInputs() {
        InputFilter[] fourDigitFilter = {
                new InputFilter.LengthFilter(4)
        };

        etPin.setFilters(fourDigitFilter);
        etConfirmPin.setFilters(fourDigitFilter);
        ...
        etPin.setOnEditorActionListener(
                (view, actionId, event) -> {
        ...
        etConfirmPin.setOnEditorActionListener(
                (view, actionId, event) -> {
                    if (actionId == EditorInfo.IME_ACTION_DONE
                            || actionId == EditorInfo.IME_ACTION_GO) {
    ...
    private void setupScreen() {
        ...
        if (isFirstSetup) {
            ...
            etConfirmPin.setHint(
                    "Confirm PIN"
            );

            confirmPinContainer.setVisibility(
                    View.VISIBLE
            );
    ...
    private void setupBiometricPrompt() {
        ...
        biometricPromptInfo =
                new BiometricPrompt.PromptInfo.Builder()
                        .setTitle(
                                "Unlock Money Manager Pro"
                        )
                        .setSubtitle(
                                "Authenticate to access your finance data"
                        )
    ...
    private boolean securePinEquals(
            String enteredPin,
            String savedPin
    ) {
        try {
    ...
    private void confirmSkipPinSetup() {
        ...
        new AlertDialog.Builder(this)
                ...
                .setMessage(
                        "Money Manager Pro will open without PIN or biometric protection. You can enable PIN Lock later from Settings."
                )
                .setNegativeButton(
                        "Cancel",
                        null
    ...
    private void setActionState(
        ...
        btnPinAction.setEnabled(
                !inProgress
        );

        btnSkipPinSetup.setEnabled(
                !inProgress
        );
